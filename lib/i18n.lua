...
local zh = {
    ...
    ["Scan QR code to log in"] = "微信扫码登录",
    ["QR login"] = "扫码登录",
    ["Manual cookie/cURL import"] = "手动导入 Cookie/cURL（备用）",
    ["Account status"] = "账号状态",
    ["Clear account data"] = "清除账号数据",
    ["Clear WeRead cookie, API key, account metadata, settings backups, and local config.lua credentials? Cached books will remain."] = "清除微信读书 Cookie、API Key、账号信息、设置备份及本地 config.lua 凭证？已缓存书籍将保留。",
    ["WeRead account data and local credential files cleared."] = "微信读书账号数据及本地凭证文件已清除。",
    ...
    ["Enter the four-digit verification code shown on your phone."] = "请输入手机页面显示的四位验证码。",
    ["Verify"] = "验证",
    ["The verification code must contain four digits."] = "验证码必须是四位数字。",
